...
function init() {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        var images = {},
            defaultImage = data[i].image;

        if (defaultImage) {

            images.s = defaultImage;
            images.m = defaultImage.split('.png')[0] + '@2x.png';
            images.l = defaultImage.split('.png')[0] + '@3x.png';
        }
